...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"><b>Reserva</b>Room </span>
    </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }}
                                    <small>{{ trans('adminlte_lang::message.login') }} 27 Dec 2016 </small>
                                </p>
                            </li>
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('edit/'.Auth::user()->id.'/edit') }}" class="btn btn-default btn-flat">{{ trans('adminlte_lang::message.profile') }}</a>
                                </div>
