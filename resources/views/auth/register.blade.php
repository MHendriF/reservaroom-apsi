    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="{{ url('/auth/register') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="{{ trans('message.nrp') }}" name="nrp" value="{{ old('nrp') }}"/>
            ...
            <a href="{{ url('/auth/login') }}" class="text-center">{{ trans('message.membreship') }}</a>
        </div><!-- /.form-box -->
    </div><!-- /.register-box -->
