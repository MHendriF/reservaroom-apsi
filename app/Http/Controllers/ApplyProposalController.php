...
class ApplyProposalController extends Controller
{
    ...
    public function index(){
        ...
        return view('applyproposal', ['data' => $model]);
    }


    public function create(){
        $model = Room::all();
        return view('add_applyproposal')->with('data', $model);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('applyproposal'); 
    }
