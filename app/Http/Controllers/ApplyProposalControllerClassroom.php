...
class ApplyProposalControllerClassroom extends Controller
{
    ...
    public function index(){
        ...
        return view('applyproposalclassroom', ['data' => $model]);
    }
    ...
    public function create(){
        ...
        return view('add_applyproposalclassroom')->with('data', $model);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('applyproposalclassroom');
    }
