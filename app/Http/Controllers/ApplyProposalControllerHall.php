...
class ApplyProposalControllerHall extends Controller
{
    ...
    public function index(){
        ...
        return view('applyproposalhall', ['data' => $model]);
    }
    ...
    public function create(){
        $model = DB::select("SELECT *
            FROM db_room
            WHERE type = 'Hall'");
        return view('add_applyproposalhall')->with('data', $model);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('applyproposalhall'); 
    }
